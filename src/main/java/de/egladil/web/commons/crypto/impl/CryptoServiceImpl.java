...
import de.egladil.web.commons.error.CommonCryptoException;
...
public class CryptoServiceImpl implements CryptoService {
	...
	@Override
	public boolean verifyPassword(final PasswordAlgorithm algorithm, final char[] password, final String persistentHashValue,
