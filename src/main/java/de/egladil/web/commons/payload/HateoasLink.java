...
public class HateoasLink {
	 ...
	 * "application/json" } ] }
	 *
	 * @param url String die URL relativ zur application
	 * @param rel String ein Substantiv, das die Beziehung ausdrückt, in dem die Resource zur aktuellen Resource steht
	 * @param method String die HttpMethod, die angewendet werden kann.
	 * @param mediatype String kommaseparierte Liste von Mediatypes, mit denen die Resource zur Verfügung gestellt
	 * werden kann.
	 */
