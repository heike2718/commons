...
*/
public interface IStringLatinConstants {
	...
	/** Alle Buchstaben und diakritischen Zeichen aus StringLatin, alle Ziffern, Leerzeichen, Minus, Unterstrich, Punkt, Komma, Apostrophe */
