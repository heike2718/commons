...
import de.egladil.web.commons.validation.HausnummerValidator;

/**
 * höchstens 10 Zeichen, Ziffern, Grundbuchstaben, Minus, Slash, Leerzeichen<br>
 * <br>
...
@Constraint(validatedBy = { HausnummerValidator.class })
public @interface Hausnummer {
